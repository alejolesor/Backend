      ...
      <form class="form-inline">
           <fieldset style="width: 103% ; background-color: white">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <button type="button" id="enviaTurnos" class="btn btn-primary">Consultar</button>
                </div>
            </div>
               <input type="hidden" name="usuario" id="usuario" value="<%=Session["IdUsuario"]%>"/>
               <input type="hidden" name="Vista2" id="vista2" value="2"/>
       <%--     <input type="button" name="idUsuario" id="idUsuario" value=":: Malla Diaria ::" class="btn btn-login" style="width: auto;" />
       --%> </fieldset>
        </form>

    <fieldset style="width: 103% ; background-color: white">
        <legend>Estado Funcionarios Turno</legend>
        <div class="row">
            <div class="col-md-12">

                  <div id="PintaMalla"></div>
                 <%--<table id="EstadoFunTurnos" class="table table-striped table-bordered display" style="text-align: center; width: auto; text-space-collapse: collapse; background-color: white;">
