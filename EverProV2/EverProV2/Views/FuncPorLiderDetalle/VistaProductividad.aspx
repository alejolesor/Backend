        ...
        <div class="row">
            <div class="col-md-12">
                <fieldset style="width: 103%; background-color: white">
                    <legend>Producción Día</legend>

                        <div style="text-align: right; margin-right: 30px"></div>
                        <table id="productividad" class="table table-striped table-bordered display" style="text-align: center; width: auto; text-space-collapse: collapse; background-color: white;">
