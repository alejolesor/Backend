...
(function (global, undefined) {
    ...
    Alertify = function () {
		 ...
		 */
        var image = "";
        if (window.location.pathname != "/Vista/Libranzas/Controles/Confirmacion.aspx") {
        ...
        dialogs = {
            buttons: {
                ...
                ok: "<a href=\"#\" class=\"alertify-button alertify-button-ok atify\" id=\"alertify-ok\">{{ok}}</a>",
            ...
            message: "<p class=\"alertify-message\"><img src='" + image + "' title='Alerta'><br><br>{{message}}</p>",
